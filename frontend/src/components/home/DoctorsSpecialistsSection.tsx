    ...
    return (
        <div className="mb-24">
            <div className="text-center mb-16 relative">
                <div className="inline-flex items-center space-x-2 bg-emerald-50 px-5 py-2 rounded-full border border-emerald-100 mb-6">
                    <span className="text-[10px] font-black text-emerald-600 uppercase tracking-[0.2em]">Our Elite Medical Team</span>
                </div>
                    ...
                    <div key={i} className="group bg-white rounded-[20px] overflow-hidden border border-gray-100 shadow-sm hover:shadow-2xl hover:shadow-emerald-500/10 transition-all duration-700 hover:-translate-y-3">
                            ...
                            <div className="absolute bottom-6 left-6 z-20">
                                <div className="bg-white/90 backdrop-blur-xl px-5 py-2.5 rounded-2xl border border-white/20 shadow-2xl">
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <p className="text-[10px] font-black text-emerald-600 uppercase tracking-widest">{doc.exp}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div className="p-8 text-left">
                            <div className="mb-8">
                                ...
                                <p className="text-emerald-500 font-bold text-sm tracking-[0.1em] italic uppercase opacity-80">{doc.spec}</p>
                            </div>
