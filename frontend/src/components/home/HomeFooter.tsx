    ...
    return (
        <footer className="mt-auto border-t border-gray-100 pt-16 pb-12 flex flex-col md:flex-row items-center justify-between text-gray-400 text-[10px]">
            <div className="flex items-center space-x-4 mb-8 md:mb-0">
                <div className="font-black text-gray-900 text-2xl uppercase tracking-tighter">MediBook<span className="text-emerald-600">AI</span></div>
            ...
            <div className="flex space-x-12 font-black uppercase tracking-[0.25em] text-[10px]">
                <a href="#" className="hover:text-emerald-600 transition-colors">Privacy Cloud</a>
                <a href="#" className="hover:text-emerald-600 transition-colors">Governance</a>
                <a href="#" className="hover:text-emerald-600 transition-colors">Help Desk</a>
            </div>
        </footer>
    );
};
